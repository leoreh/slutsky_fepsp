...
Here you will find resources designed to assist in the recordings of *in vivo* field excitatory post synaptic potentials (fEPSPs) alongside a MATLAB© based package for the analysis of the recorded signals.
